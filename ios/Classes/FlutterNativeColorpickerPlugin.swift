...
@available(iOS 14.0, *)
public class FlutterNativeColorpickerPlugin: NSObject, FlutterPlugin {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    let handler = FlutterNativeColorpickerEventHandler()
    picker.delegate = handler
    eventChannel.setStreamHandler(handler)
    
    let instance = FlutterNativeColorpickerPlugin(picker)
...
@available(iOS 14.0, *)
public class FlutterNativeColorpickerEventHandler : NSObject, FlutterStreamHandler, UIColorPickerViewControllerDelegate {
